...
export const realtimeData = {
  ...
  planPrompt: `realtime_data — ค้นข้อมูล real-time จากอินเทอร์เน็ต (Serper)
ใช้เมื่อ:
- ข่าวล่าสุด, พยากรณ์อากาศ, ราคา (หุ้น/คริปโต/สินค้า), เหตุการณ์ปัจจุบัน
- user สั่งให้ค้นหาจากอินเทอร์เน็ตโดยตรง

ห้ามใช้สำหรับ:
- วัน/เวลา (มีใน KG Time แล้ว)
- สถานะอุปกรณ์ (มีใน KG แล้ว)
- ทักทาย/สนทนาทั่วไป

query ใส่ keyword สั้นๆ ตรงประเด็น เติม time qualifier เมื่อจำเป็น (เช่น "ล่าสุด", "วันนี้", "today")`,
